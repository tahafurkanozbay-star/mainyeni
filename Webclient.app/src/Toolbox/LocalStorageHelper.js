...
const parseEnvelope = (text) => {
    ...
    try {
        ...
        // Legacy AES values were encrypted with a key shipped to every browser, so they
        // were not a meaningful security boundary. Unreadable legacy ciphertext fails
        // closed instead of keeping an undeclared browser crypto dependency.
        return null;
    }
};
