...
const MAP_TARGET: WorkspaceShortcutTarget = Object.freeze({
  selector: '#esri-map-container',
  label: 'harita',
});

const SIDEBAR_TARGET: WorkspaceShortcutTarget = Object.freeze({
  selector: '#sidebar',
  label: 'araç paneli',
});
