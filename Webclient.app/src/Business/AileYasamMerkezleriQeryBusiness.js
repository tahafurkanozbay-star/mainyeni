...
export const AileYasamMerkezleriQeryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniAileYasamMerkezleriQeryUrl",_query,_returnGeometry);
    }
}