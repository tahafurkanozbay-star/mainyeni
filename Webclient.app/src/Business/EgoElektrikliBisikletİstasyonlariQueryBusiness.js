...
export const EgoElektrikliBisikletİstasyonlariQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniEgoElektrikliBisikletİstasyonlariQueryUrl",_query,_returnGeometry);
    }
}