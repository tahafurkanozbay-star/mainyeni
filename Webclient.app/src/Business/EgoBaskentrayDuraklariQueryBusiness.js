...
export const EgoBaskentrayDuraklariQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniEgoBaskentrayDuraklariQueryUrl",_query,_returnGeometry);
    }
}