...
export const EgoKartDolumNoktalariQeryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniEgoKartDolumNoktalariQeryUrl",_query,_returnGeometry);
    }
}