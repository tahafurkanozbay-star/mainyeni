...
export const EgoAnkarayDuraklariQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniEgoAnkarayDuraklariQueryUrl",_query,_returnGeometry);
    }
}