...
export const AskiBolgeMudurlukleriQeryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniAskiBolgeMudurlukleriQeryUrl",_query,_returnGeometry);
    }
}