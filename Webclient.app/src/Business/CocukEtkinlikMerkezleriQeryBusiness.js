...
export const CocukEtkinlikMerkezleriQeryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniCocukEtkinlikMerkezleriQeryUrl",_query,_returnGeometry);
    }
}