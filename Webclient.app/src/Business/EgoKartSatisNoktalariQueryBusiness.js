...
export const EgoKartSatisNoktalariQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniEgoKartSatisNoktalariQueryUrl",_query,_returnGeometry);
    }
}