...
export const EgoOtobusDuraklariQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniEgoOtobusDuraklariQueryUrl",_query,_returnGeometry);
    }
}