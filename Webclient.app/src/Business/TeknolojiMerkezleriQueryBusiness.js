...
export const TeknolojiMerkezleriQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniTeknolojiMerkezleriQueryUrl",_query,_returnGeometry);
    }
}