        ...
        return new Promise((resolve, reject) => {
            ...
            if (_query.showNearby) {
                ...
                if (_query != null) {
                    ...
                    if (!IsNull(_query.startDate)) {
                        options.where += " AND baslangictarihi >= " + _query.startDate.getTime();
                    }
                    if (!IsNull(_query.endDate)) {
                        options.where += " AND bitistarihi <= " +  _query.endDate.getTime();
                    }
                }
