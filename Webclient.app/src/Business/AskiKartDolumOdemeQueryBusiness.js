...
export const AskiKartDolumOdemeQueryBusiness={

    Query:async(_query, _returnGeometry)=>{
        return FastAccessQueryBusiness.QueryFastAccessService("YeniAskiKartDolumOdemeQueryUrl",_query,_returnGeometry);
    }
}