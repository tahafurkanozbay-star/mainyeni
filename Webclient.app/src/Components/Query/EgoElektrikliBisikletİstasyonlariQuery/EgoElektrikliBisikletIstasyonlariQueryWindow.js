...
export const EgoElektrikliBisikletIstasyonlariQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Ego Elektrikli Bisiklet İstasyonları";
    const windowLogo = "images/Sidebar/EGO/elektriklibisikletistasyonlari.png";
    const windowLogoicon = "images/icons/map/EGO/elektirklibisiklet.svg";
   ...
   const fetchQueryResults = () => {
        ...
        LoggingBusiness.CreateClientLog("Yaşlı Dostu/Sorgu", query.districtName+"/"+query.nbhoodName+"/"+query.name);

        EgoElektrikliBisikletİstasyonlariQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEgoElektrikliBisikletİstasyonlariQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EgoElektrikliBisikletİstasyonlariQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
