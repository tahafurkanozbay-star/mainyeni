...
export const EgoBaskentrayDuraklariQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Ego Baskentray Durakları";
    const windowLogo = "images/Sidebar/EGO/baskentray.png";
    const windowLogoicon = "images/icons/map/EGO/baskentray.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EgoBaskentrayDuraklariQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEgoBaskentrayDuraklariQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EgoBaskentrayDuraklariQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
