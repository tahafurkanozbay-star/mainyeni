...
export const AnfaKafelerQeryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Anfa Kafeler";
    const windowLogo = "images/Sidebar/ISTIRAK/anfakafeler.png";
    const windowLogoicon = "images/icons/map/ISTIRAK/anfakafeler.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AnfaKafelerQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAnfaKafelerQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AnfaKafelerQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
