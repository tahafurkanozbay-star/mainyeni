...
export const AskiTahsilatSubeQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Aski Tahsilat Şube";
    const windowLogo = "images/Sidebar/ASKI/askitahsilatsube.png";
    const windowLogoicon = "images/icons/map/ASKİ/tahsilatsubeleri.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AskiTahsilatSubeQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAskiTahsilatSubeQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AskiTahsilatSubeQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
