...
export const AnfaOtoparkQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Anfa Otopark";
    const windowLogo = "images/Sidebar/ISTIRAK/anfaotopark.png";
    const windowLogoicon = "images/icons/map/ISTIRAK/anfaotopark.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AnfaOtoparkQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAnfaOtoparkQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AnfaOtoparkQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
