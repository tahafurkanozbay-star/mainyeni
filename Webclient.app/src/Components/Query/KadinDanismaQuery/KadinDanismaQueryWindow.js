...
export const KadinDanismaQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Kadin Danışma Merkezleri";
    const windowLogo = "images/Sidebar/ABB/kadindanismamerkezleri.png";
    const windowLogoicon = "images/icons/map/ABB/kadindayanismamerkezi.svg";
   ...
   const fetchQueryResults = () => {
        ...
        KadinDanismaQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniKadinDanismaQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            KadinDanismaQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
