...
export const AskiAtıkSuTesisleriQeryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Aski Atık Su Tesisleri";
    const windowLogo = "images/Sidebar/ASKI/askiatiksutesisleri.png";
    const windowLogoicon = "images/icons/map/ASKİ/atiksutesisleri.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AskiAtıkSuTesisleriQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAskiAtıkSuTesisleriQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AskiAtıkSuTesisleriQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
