...
export const EgoTeleferikDuraklariQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Ego Teleferik Durakları";
    const windowLogo = "images/Sidebar/EGO/teleferik.png";
    const windowLogoicon = "images/icons/map/EGO/teleferik.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EgoTeleferikDuraklariQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEgoTeleferikDuraklariQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EgoTeleferikDuraklariQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
