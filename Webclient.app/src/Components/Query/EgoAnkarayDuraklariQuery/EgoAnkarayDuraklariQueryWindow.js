...
export const EgoAnkarayDuraklariQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Ego Ankaray Durakları";
    const windowLogo = "images/Sidebar/EGO/ankaray.png";
    const windowLogoicon = "images/icons/map/EGO/ankaray.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EgoAnkarayDuraklariQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEgoAnkarayDuraklariQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EgoAnkarayDuraklariQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
