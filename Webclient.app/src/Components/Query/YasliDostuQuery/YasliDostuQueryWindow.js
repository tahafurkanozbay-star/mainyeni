...
export const YasliDostuQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Yaşlı Dostu";
    const windowLogo = "images/Sidebar/ABB/yaslıdostumekanlar.png";
    const windowLogoicon = "images/icons/map/ABB/yaslidostuuygulamalar.svg";
   ...
   const fetchQueryResults = () => {
        ...
        YasliDostuQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniYasliDostuQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            YasliDostuQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
