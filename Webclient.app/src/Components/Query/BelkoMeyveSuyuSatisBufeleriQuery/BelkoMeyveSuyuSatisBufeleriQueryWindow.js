...
export const BelkoMeyveSuyuSatisBufeleriQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Belko Meyve Suyu Satış Büfeleri";
    const windowLogo = "images/Sidebar/ISTIRAK/belkomeyvesuyusatis.png";
    const windowLogoicon = "images/icons/map/ISTIRAK/belkomeyvesuyu.svg";
   ...
   const fetchQueryResults = () => {
        ...
        BelkoMeyveSuyuSatisBufeleriQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniBelkoMeyveSuyuSatisBufeleriQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            BelkoMeyveSuyuSatisBufeleriQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
