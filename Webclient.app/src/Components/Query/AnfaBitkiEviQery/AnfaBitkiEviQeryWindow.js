...
export const AnfaBitkiEviQeryWindow = React.forwardRef(
    (props, ref) => {

    const windowTitle = "Anfa Bitki Evi";
    const windowLogo = "images/Sidebar/ISTIRAK/anfabitkievi.png";
    const windowLogoicon = "images/icons/map/ISTIRAK/anfabitkievi.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AnfaBitkiEviQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAnfaBitkiEviQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AnfaBitkiEviQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
