...
export const EngelliCocukQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Engelsiz Kreşler";
    const windowLogo = "images/Sidebar/ABB/engellicocuklar.png";
    const windowLogoicon = "images/icons/map/ABB/engelsizkres.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EngelliCocukQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEngelliCocukQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EngelliCocukQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
