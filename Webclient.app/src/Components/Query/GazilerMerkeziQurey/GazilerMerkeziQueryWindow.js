...
export const GazilerMerkeziQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Gaziler Merkezi";
    const windowLogo = "images/Sidebar/ABB/gazimerkezleri.png";
    const windowLogoicon = "images/icons/map/ABB/gazimerkezleri.svg";
   ...
   const fetchQueryResults = () => {
        ...
        GazilerMerkeziQeyBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniGazilerMerkeziQeyUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            GazilerMerkeziQeyBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
