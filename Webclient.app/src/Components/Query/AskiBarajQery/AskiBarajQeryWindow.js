...
export const AskiBarajQeryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Aski Baraj";
    const windowLogo = "images/Sidebar/ASKI/askibaraj.png";
    const windowLogoicon = "images/icons/map/ASKİ/askibaraj.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AskiBarajQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAskiBarajQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AskiBarajQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
