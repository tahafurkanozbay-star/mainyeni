...
export const SosyalHizmetlerQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Sosyal Hizmetler";
    const windowLogo = "images/Sidebar/ABB/sosyaltesisler.png";
    const windowLogoicon = "images/icons/map/ABB/sosyalhizmetler.svg";
   ...
   const fetchQueryResults = () => {
        ...
        SosyalHizmetlerQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniSosyalHizmetlerQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            SosyalHizmetlerQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
