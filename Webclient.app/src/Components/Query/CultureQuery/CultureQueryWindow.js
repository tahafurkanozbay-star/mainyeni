...
export const CultureQueryWindow = React.forwardRef((props, ref) => {

    registerLocale('tr', tr)

    const windowTitle = "Kültür ve Sanat";  

    const windowLogo = "images/Sidebar/ABB/kulturvesanat.png";
    const windowLogoicon = "images/icons/map/ABB/kultursanat.svg";
   ...
   const fetchQueryResults = () => {
        ...
        CultureQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniKültürSanatQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            CultureQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
