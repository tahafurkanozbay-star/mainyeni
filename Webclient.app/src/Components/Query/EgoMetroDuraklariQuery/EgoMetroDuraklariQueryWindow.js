...
export const EgoMetroDuraklariQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Ego Metro Durakları";
    const windowLogo = "images/Sidebar/EGO/metro.png";
    const windowLogoicon = "images/icons/map/EGO/metrohatti.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EgoMetroDuraklariQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEgoMetroDuraklariQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EgoMetroDuraklariQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
