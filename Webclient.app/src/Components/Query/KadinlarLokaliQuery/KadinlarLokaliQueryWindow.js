...
import { FiLink, FiMapPin, FiPhone, FiWifi } from "react-icons/fi";
...
export const KadinlarLokaliQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Kadinlar Lokali";
    const windowLogo = "images/Sidebar/ABB/kadinlarlokali.png";
    const windowLogoicon = "images/icons/map/ABB/kadinlarlokali.svg";
   ...
   const fetchQueryResults = () => {
        ...
        KadinLokaliQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniKadinlarLokaliQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            KadinLokaliQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
