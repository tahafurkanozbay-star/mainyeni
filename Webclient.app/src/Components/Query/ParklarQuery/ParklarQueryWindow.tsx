...
import { ExperienceInput } from '../../Common/ExperienceForm';
...
interface ParkDetail { geometry?: GeometryLike }
interface DisposableHandle { remove?: () => void }
interface LayerLike { renderer?: { symbol?: unknown }; refresh?: () => void; queryExtent?: () => Promise<{ extent?: any }>; destroy?: () => void }
interface ClusterLike { layerObj?: LayerLike }
