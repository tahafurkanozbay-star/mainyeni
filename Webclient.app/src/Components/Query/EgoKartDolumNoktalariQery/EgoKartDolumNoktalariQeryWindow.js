...
export const EgoKartDolumNoktalariQeryWindow= React.forwardRef((props, ref) => {

    const windowTitle = "Ego Kart Dolum Noktaları";
    const windowLogo = "images/Sidebar/EGO/egokartdolum.png";
    const windowLogoicon = "images/icons/map/EGO/kartdolum.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EgoKartDolumNoktalariQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEgoKartDolumNoktalariQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EgoKartDolumNoktalariQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
