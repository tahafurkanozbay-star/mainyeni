...
export const EngelliBireyQeryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Engelli Birey";
    const windowLogo = "images/Sidebar/ABB/engellibireyler.png";
    const windowLogoicon = "images/icons/map/ABB/engelsizyasam.svg";
   ...
   const fetchQueryResults = () => {
        ...
        EngelliBireyQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniEngelliBireyQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            EngelliBireyQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
