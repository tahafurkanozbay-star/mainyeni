...
export const AskiKartDolumOdemeQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Aski Kart Dolum ve Ödeme Noktaları";
    const windowLogo = "images/Sidebar/ASKI/askikartdolum.png";
    const windowLogoicon = "images/icons/map/ASKİ/askikartdolum.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AskiKartDolumOdemeQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAskiKartDolumOdemeQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AskiKartDolumOdemeQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
