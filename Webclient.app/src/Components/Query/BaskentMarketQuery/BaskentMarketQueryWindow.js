...
export const BaskentMarketQueryWindow = React.forwardRef((props, ref) => {


    const windowTitle = "Başkent Market";
    const windowLogo = "images/icons/sidebar/baskentmarket.png"
    const windowLogoicon = "images/icons/map/ISTIRAK/baskentmarket.svg";
   ...
   const fetchQueryResults = () => {
        ...
        BaskentMarketQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniBaskentMarketQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            BaskentMarketQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
