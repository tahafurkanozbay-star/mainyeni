...
export const CocukEtkinlikMerkezleriQeryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Çocuk Etkinlik Merkezleri";
    const windowLogo = "images/Sidebar/ABB/cocukmerkezleri.png";
    const windowLogoicon = "images/icons/map/ABB/cocuketkinlikmerkezleri.svg";
   ...
   const fetchQueryResults = () => {
        ...
        CocukEtkinlikMerkezleriQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniCocukEtkinlikMerkezleriQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            CocukEtkinlikMerkezleriQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
