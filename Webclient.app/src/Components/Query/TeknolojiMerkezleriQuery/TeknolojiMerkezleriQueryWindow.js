...
export const TeknolojiMerkezleriQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Teknoloji Merkezleri";
    const windowLogo = "images/Sidebar/ABB/esporteknoloji.png";
    const windowLogoicon = "images/icons/map/ABB/teknolojimerkezleri.svg";
   ...
   const fetchQueryResults = () => {
        ...
        TeknolojiMerkezleriQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniTeknolojiMerkezleriQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            TeknolojiMerkezleriQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
