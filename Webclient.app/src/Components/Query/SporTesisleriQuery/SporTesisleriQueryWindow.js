...
export const SporTesisleriQueryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Spor Tesisleri";
    const windowLogo = "images/Sidebar/ABB/esportesisleri.png";
    const windowLogoicon = "images/icons/map/ABB/esportesisleri.svg";
   ...
   const fetchQueryResults = () => {
        ...
        SporTesisleriQeryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniSporTesisleriQeryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            SporTesisleriQeryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
