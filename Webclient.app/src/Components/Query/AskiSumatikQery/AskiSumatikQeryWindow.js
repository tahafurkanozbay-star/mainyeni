...
export const AskiSumatikQeryWindow = React.forwardRef((props, ref) => {

    const windowTitle = "Aski Sumatik";
    const windowLogo = "images/Sidebar/ASKI/askisumatik.png";
    const windowLogoicon = "images/icons/map/ASKİ/sumatik.svg";
   ...
   const fetchQueryResults = () => {
        ...
        AskiSumatikQueryBusiness.Query(query,false).then((_result) => {
            ...
            if (_result.type == Constants_ServiceResultType.Success) {
                ...
                mapView.goTo(targetExtent).then(() => {
                    ...
                    CommonBusiness.Clustering.CreateLayerWithoutClustering("YeniAskiSumatikQueryUrl", props.windowTitle, query, initialSymbol).then((_clusterLayer) => {
                        removeLastClusterLayer();
    ...
    const getItemDetailsById=async(_item)=>{
        ...
        return new Promise((resolve, reject)=>{
            AskiSumatikQueryBusiness.Query({ObjectId: _item.ObjectId},true).then((_result) => {
                if(_result.type==Constants_ServiceResultType.Success){
