...
export const Page404 = () => {
    ...
    return (<>
        <div className="page page404-body">
            <div className="row">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z" />
                ...
                <div className="col-md-6 align-self-center">
                    ...
                    <h2 className='page404-header-2'>Sayfa bulunamadı</h2>
                    <p className='page404-description'>
                        Aradığınız sayfa bulunamadı.
                        Aşağıdaki butona tıklayarak giriş sayfasına
                        geri dönebilirsiniz.
                    </p>
                    <button className="btn green" onClick={(e) => window.location.href = "/"}>Giriş'e dön</button>
                </div>
            </div>
        </div>
    </>);
