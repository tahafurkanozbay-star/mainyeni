import { createKmlDocument, type GeoJsonGeometry } from './kmlSerializer';

describe('kmlSerializer', () => {
  test('serializes point geometry using the KML 2.2 namespace', () => {
  ...
  test('serializes polygon outer and inner rings without mutating the input', () => {
    const geometry: GeoJsonGeometry = Object.freeze({
      type: 'Polygon',
