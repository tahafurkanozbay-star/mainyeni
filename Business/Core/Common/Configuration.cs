...
namespace Business.Core.Common
{
    public partial class Configuration
    {
        ...
        // Kept compatible with the existing deployment until LDAP configuration is moved to DI/options.
        public static string LDAP_DOMAIN = Environment.GetEnvironmentVariable("KENT_REHBERI_LDAP_DOMAIN") ?? "manisa.bel.tr";
